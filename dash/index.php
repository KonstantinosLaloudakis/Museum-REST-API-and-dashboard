...
-->
                ...
                <div class="container-fluid">
                    ...
                    $sqll = "SELECT  Count(*) as totalVisitors, SUM(isVip) as vipVisitors from visitorids";
            ...
            --><!-- End of Footer -->
                    ...
                    <div class="col-12 mt-4">
                        <div class="row">
                            ...
                            $sqll = "SELECT grouped_data.sensor_id AS sensor ,COUNT(grouped_data.sensor_id) as totalVisits FROM (SELECT id,MIN(time_in) as time_in,MIN(time_out) as time_out,visitor_id,sensor_id FROM `beacon_data_test` where sensor_id != 0 GROUP BY visitor_id,sensor_id) AS grouped_data GROUP BY grouped_data.sensor_id Order by COUNT(grouped_data.sensor_id) DESC LIMIT 1;";
                                    ...
                                    <div class="col-md-4">
                                        <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body">
												...
												<b><?php echo $row['totalVisits']; ?> ΕΠΙΣΚΕΨΕΙΣ. </b>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
